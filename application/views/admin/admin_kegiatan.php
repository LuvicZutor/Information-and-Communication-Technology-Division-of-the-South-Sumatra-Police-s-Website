            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="<?= base_url('admin/admin_kegiatan'); ?>">Kegiatan</a>
                    </div>
                </div>
            </li>
                        ...
                        <section class="section-aboutus">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <br><br>
                                    <div class="h4 mb-0 font-weight-bold text-gray-800 offset-lg-10">
                                        <?php echo anchor('admin/edit/' . $k->id, 'Edit kegiatan ' . $k->id); ?>
                                    </div>
                        </section>
                        <br><br>
                    <?php } ?>
